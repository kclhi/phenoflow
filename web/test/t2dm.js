...
describe('t2dm', () => {
	...
	describe('/POST create T2DM workflow', () => {
		...
		it('Add read potential cases implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "read-potential-cases.knwf", USERNAME);
		});
		...
		it('Add abnormal lab implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "abnormal-lab.knwf", USERNAME);
		});
		...
		it('Add rx_t2dm_med-abnormal-lab implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "rx_t2dm_med-abnormal-lab.knwf", USERNAME);
		});

		it('Add rx_t2dm_med-abnormal-lab alternative implementation.', async() => {
			await Workflow.implementation(stepId, "python", "test/implementation/python/", "rx_t2dm_med-abnormal-lab.py", USERNAME);
		});
		...
		it('Add dx_t2dm-abnormal-lab implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "dx_t2dm-abnormal-lab.knwf", USERNAME);
		});
		...
		it('Add dx_t2dm-rx_t2dm_med implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "dx_t2dm-rx_t2dm_med.knwf", USERNAME);
		});
		...
		it('Add dx_t2dm-rx_tdm_med-prec implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "dx_t2dm-rx_tdm_med-prec.knwf", USERNAME);
		});
		...
		it('Add dx_t2dm-rx_t1dm_med-dx2 implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "dx_t2dm-rx_t1dm_med-dx2.knwf", USERNAME);
		});
		...
		it('Add output-cases implementation.', async() => {
			await Workflow.implementation(stepId, "knime", "test/implementation/knime/", "output-cases.knwf", USERNAME);
		});
