...
describe("caliber importer", () => {
  ...
  describe("/POST import caliber csv", () => {
    ...
    it("[CI7] Imported, overlapping sibling workflows should be identified as such", async() => {
      await WorkflowUtils.analyseSiblings();
    }).timeout(0);

    it("[CI8] Imported, overlapping hierarchical workflows should be identified as such", async() => {
